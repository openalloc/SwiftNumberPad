...
class DecimalTests: XCTestCase {
    ...
    func testPenny() throws {
        let x = NPDecimalConfig(0.0, precision: 2)
        XCTAssertEqual("0", x.stringValue)
        XCTAssertEqual(0, x.value)
    ...
    func testIgnoreIfBeyondPrecision() throws {
        let x = NPDecimalConfig(0.01, precision: 2)
    ...
    func testAddDecimalOnDecimal() throws {
        let x = NPDecimalConfig(Decimal(30), precision: 1, upperBound: Decimal(500))
    ...
    func testToValue() throws {
        let x = NPDecimalConfig(Decimal(0), precision: 1, upperBound: Decimal(500))
